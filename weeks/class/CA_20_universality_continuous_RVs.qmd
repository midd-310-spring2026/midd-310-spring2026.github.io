...
```{r}
# create a sequence of values from 0 and 10 at equally-size 0.01 increments
x_seq <- seq(0, 2, 0.01)
...
How can we simulate values from the $\text{Exp}(1)$ distribution?
...
hist(x, xlab = "x", main = "Exp(1) rvs", freq = F)

...
\item \textbf{Midterm exams}. Two midterm exams are designed as an opportunities to assess the knowledge you’ve learned. The second midterm is lightly cumulative. The \emph{tentative} dates for these assessments are as follows. Exact dates and times will be confirmed at least two weeks in advance.
\begin{itemize}
...
\textbf{1} & 2/09 & M -  Welcome! Course logistics \\
	...
	\hline   
\textbf{2} & 2/16 & M - Counting cont., Axioms of probability \\  
                && (T - Problem Set 01 due) \\  
	&& W -    Intro to R and RStudio, Conditional probability \\
 && F -   Bayes rule, LoTP \\
	\hline   
